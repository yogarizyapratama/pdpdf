            ...
            <div className="text-center mb-8">
              <div className="flex justify-center mb-4">
                <div className="p-4 bg-red-100 dark:bg-red-900 rounded-full">
                  <Trash2 className="h-12 w-12 text-red-600 dark:text-red-400" />
                </div>
              </div>
        ...
        <PDFThumbnailsGrid pdfFile={file} totalPages={totalPages} />
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        setPagesToRemove([...new Set(pages)].sort((a, b) => a - b))
                      }}
                    />
                  </div>
                  ...
                  {pagesToRemove.length > 0 && (
                    <div className="bg-red-50 dark:bg-red-950/20 rounded-lg p-4">
                      <h4 className="font-medium text-red-900 dark:text-red-100 mb-2">
                        Pages to Remove: {pagesToRemove.length}
                      </h4>
                      <div className="flex flex-wrap gap-2">
                        {pagesToRemove.map(page => (
                          <span 
                            key={page}
                            className="inline-flex items-center px-3 py-1 bg-red-600 text-white rounded-full text-sm"
                          >
                            Page {page}
                            <button
                              onClick={() => togglePageRemoval(page)}
                ...
                {totalPages > 0 && (
                  <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
                      ...
                      Page Preview - Click to Select for Removal
                    </h3>
                    
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
                      Click on the pages you want to remove. Selected pages will be highlighted in red.
                    </p>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                      {Array.from({ length: totalPages }, (_, index) => (
                        <PDFPagePreview
                          ...
                          width={150}
                          height={200}
                          isSelected={pagesToRemove.includes(index + 1)}
                    ...
                    {pagesToRemove.length > 0 && (
                      <div className="mt-6 p-4 bg-red-50 dark:bg-red-950/20 rounded-lg">
                        <h4 className="font-medium text-red-900 dark:text-red-100 mb-2">
                          📋 Summary: {pagesToRemove.length} pages selected for removal
                        </h4>
                        <p className="text-sm text-red-700 dark:text-red-300">
                          Pages to remove: {pagesToRemove.sort((a, b) => a - b).join(', ')}
                        </p>
                        <p className="text-sm text-red-700 dark:text-red-300 mt-1">
                          Remaining pages: {totalPages - pagesToRemove.length}
                        </p>
                      </div>
                    )}
                  </div>
            ...
            <div className="mt-8 bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-300">
                ...
                <li>Specify which pages to remove (e.g., 1,3,5-7)</li>
                <li>Review the pages to be removed</li>
                <li>Click &ldquo;Remove Pages&rdquo; to process the file</li>
              ...
              <div className="mt-6 p-4 bg-green-50 dark:bg-green-950/20 rounded-lg">
                ...
                <p className="text-sm text-green-700 dark:text-green-300">
                  Advanced page management with visual preview. Select and remove specific pages with precision.
                </p>
              </div>
            </div>
          </div>
