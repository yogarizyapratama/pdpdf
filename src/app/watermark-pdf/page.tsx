          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300">
                Add custom watermark text to your PDF documents securely
              </p>
            </div>
            ...
            <div className="mt-8 bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-300">
                ...
                <li>Click &quot;Add Watermark&quot; to process the file</li>
              ...
              <div className="mt-6 p-4 bg-purple-50 dark:bg-purple-950/20 rounded-lg">
                ...
                <ul className="text-sm text-purple-700 dark:text-purple-300 space-y-1">
                  <li>• Use watermarks to protect document authenticity</li>
                  <li>• Common watermarks: &quot;CONFIDENTIAL&quot;, &quot;DRAFT&quot;, &quot;COPY&quot;</li>
                  <li>• Watermarks appear on all pages of the document</li>
                </ul>
              </div>
              ...
              <div className="mt-6 p-4 bg-green-50 dark:bg-green-950/20 rounded-lg">
                ...
                <p className="text-sm text-green-700 dark:text-green-300">
                  Professional watermarking with customizable options. Add text or image watermarks to protect your documents.
                </p>
              </div>
            </div>
          </div>
